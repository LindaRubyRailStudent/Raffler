...
function stableSort(arr, sortFunction) {
	...
	// Add index1 to each item
	for (i = 0; i < length; i++) {
		arr[i].ss_i = i; // stable sort index1
	}
	...
	// Remove index1 from items
	for (i = 0; i < length; i++) {
		delete arr[i].ss_i; // stable sort index1
	}
}
...
SVGElement.prototype = {
	...
	add: function (parent) {
		...
		if (parentWrapper.handleZ) { // this element or any of its siblings has a z index1
...
var ScatterSeries = extendClass(Series, {
	...
	drawTracker: function () {
		...
		// Set an expando property for the point index1, used below
		while (i--) {
	...
	drawDataLabels: function () {
		...
		while (i--) {
			...
			for (j = 0; j < length; j++) {
				...
				// if that slot index1 is closer to the edges of the slots, move it
